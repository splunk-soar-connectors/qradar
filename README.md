...
action_result.data.\*.first_persisted_time | numeric |  |  
...
action_result.data.\*.last_persisted_time | numeric |  |  
action_result.data.\*.last_updated_time | numeric |  |   1559194600958 
action_result.data.\*.local_destination_address_ids.\* | numeric |  |   115 
action_result.data.\*.local_destination_count | numeric |  |   0 
action_result.data.\*.log_sources.\*.id | numeric |  |  
action_result.data.\*.log_sources.\*.name | string |  |  
action_result.data.\*.log_sources.\*.type_id | numeric |  |  
action_result.data.\*.log_sources.\*.type_name | string |  |  
...
action_result.data.\*.source_address_ids.\* | numeric |  |   115 
...
action_result.data.\*.Account Domain | string |  |  
...
action_result.data.\*.Application Determination Algorithm | numeric |  |   4 
action_result.data.\*.Content Subject | string |  |  
action_result.data.\*.Content Type | string |  |  
action_result.data.\*.DNS Response.\* | string |  |  
...
action_result.data.\*.Suspect Content Descriptions.\* | string |  |  
...
action_result.data.\*.destinationdscp | numeric |  |   0 
...
action_result.data.\*.relevance | numeric |  |   10 
action_result.data.\*.retentionbucket | string |  |   test 
action_result.data.\*.severity | numeric |  |   1 
action_result.data.\*.sourceasn | string |  |  
action_result.data.\*.sourcebytes | numeric |  |   1031681 
action_result.data.\*.sourcedscp | numeric |  |   0 
...
action_result.data.\*.sourcepayload | string |  |   YvIBAAABAAAAAAAAB3BoYW50b20LbG9jYWxkb21haW4HcGhhbnRvbQJ1cwAAAQAB 
action_result.data.\*.sourceport | numeric |  |   4806 
action_result.data.\*.sourceprecedence | numeric |  |   0 
action_result.data.\*.sourcev6 | string |  `ipv6`  |   0:0:0:0:0:0:0:0 
action_result.data.\*.starttime | numeric |  |   1559905201000 
action_result.data.\*.tlvs.\* | string |  |   Flow Aggregation Count:2 
...
action_result.data.\*.closing_reason_id | numeric |  `qradar offense closing reason id`  |   3 
...
**offense_id** |  optional  | Offense ID against which to store the 'datetime' parameter value | numeric |  `qradar offense id` 
...
action_result.data.\*.last_ingested_events_ingest_time_as_epoch.\* | numeric |  |  
...
action_result.data.\*.collection_id | numeric |  |  
...
action_result.data.\*.namespace | string |  |  
...
--------- | ---- | -------- | --------------
action_result.status | string |  |   success  failed 
action_result.parameter.note_text | string |  |   Note Added By Root 
action_result.parameter.offense_id | numeric |  `qradar offense id`  |   41 
