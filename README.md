...
action\_result\.data\.\*\.Account Domain | string |  |  
...
action\_result\.data\.\*\.Recipient Users\.\* | string |  |  
action\_result\.data\.\*\.Request URL | string |  |  
action\_result\.data\.\*\.Search Arguments | string |  |  
action\_result\.data\.\*\.Suspect Content Descriptions\.\* | string |  |  
...
action\_result\.data\.\*\.destinationdscp | numeric |  |   0 
...
action\_result\.data\.\*\.destinationpayload | string |  |   YvKBgwABAAAAAQAAB3BoYW50b20LbG9jYWxkb21haW4HcGhhbnRvbQJ1cwAAAQABwCAABgABAAAC\+gAmAmRjwCAKaG9zdG1hc3RlcsAgAAhilQAAA4QAAAJYAAFRgAAADhA= 
action\_result\.data\.\*\.destinationport | numeric |  `port`  |   3365 
action\_result\.data\.\*\.destinationprecedence | numeric |  |   0 
action\_result\.data\.\*\.destinationv6 | string |  |   0\:0\:0\:0\:0\:0\:0\:0 
action\_result\.data\.\*\.domainid | numeric |  |   0 
...
action\_result\.data\.\*\.closing\_reason\_id | numeric |  `qradar offense closing reason id`  |   3 
...
action\_result\.data\.\*\.last\_ingested\_events\_ingest\_time\_as\_epoch\.\* | numeric |  |  
...
action\_result\.data\.\*\.collection\_id | numeric |  |  
...
action\_result\.data\.\*\.namespace | string |  |  
...
--------- | ---- | -------- | --------------
action\_result\.status | string |  |   success  failed 
action\_result\.parameter\.note\_text | string |  |   Note Added By Root 
action\_result\.parameter\.offense\_id | numeric |  `qradar offense id`  |   41 
