...
action\_result\.data\.\*\.local\_destination\_address\_ids\.\* | numeric | 
...
action\_result\.data\.\*\.source\_address\_ids\.\* | numeric | 
...
action\_result\.data\.\*\.partialormatchlist\.\* | numeric | 
...
action\_result\.data\.\*\.sourcev6 | string |  `ipv6` 
action\_result\.data\.\*\.starttime | numeric | 
action\_result\.data\.\*\.tlvs\.\* | string | 
